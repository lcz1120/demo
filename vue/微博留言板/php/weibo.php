...
**********************************************
	...
	usage:
			...
			weibo.php?act=acc&id=1			顶某一条数据
				返回：{error:0}
			
			weibo.php?act=ref&id=1			踩某一条数据
				返回：{error:0}
				
			weibo.php?act=del&id=1	  		删除某一条数据
				返回：{error:0}
...
//创建数据库
$db=@mysql_connect('192.168.3.15', 'root', 'root') or @mysql_connect('localhost', 'root', 'root');
